		...
		<div class="sidebar" data-color="green" data-background-color="white">
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="list_produk">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header card-header-success kartu">
									...
									<p class="card-category">Daftar Donasi telah dibuat</p>
								</div>
												...
												<tr>
													...
													<td class="td-actions">
														...
														<button type="button" rel="tooltip" title="Hapus" class="btn btn-danger btn-link btn-sm">
															<i class="material-icons"><?php echo anchor('List_Donasi/delete/' . $don['kode_donasi'], 'delete'); ?></i>
														</button>
													</td>
												</tr>
											<?php endforeach; ?>
