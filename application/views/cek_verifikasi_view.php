						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header card-header-success kartu">
									<h4 class="card-title">Cek Verifikasi</h4>
									<p class="card-category">Cek validasi Member</p>
								</div>
												...
												<tr>
													...
													<td class="td-actions ">
														...
														<button type="button" rel="tooltip" title="Tolak" class="btn btn-danger btn-link btn-sm">
															<i class="material-icons"><?php echo anchor('Cek_Verifikasi/delete/' . $u->email, 'close_outline'); ?></i>
														</button>
													</td><?php } ?>
												</tr>
										</tbody>
